            ...
            <div class="row align-items-center justify-content-xl-between">
                <div class="col-xl-6">
                    <div class="copyright text-center text-xl-left text-muted">
                        &copy; 2024 <a href="https://iessoterohernandez.es/" target="_blank"
                            class="font-weight-bold ml-1">{{ config('app.name') }}</a>
                    </div>
                </div>
                <div class="col-xl-6">
                    <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                        <li class="nav-item">
                            <a href="https://www.google.es/maps/place/IES+Sotero+Hern%C3%A1ndez/@37.3623276,-6.0373655,17z/data=!3m1!4b1!4m6!3m5!1s0xd126d5d1644770f:0xbb6742529c87c8ef!8m2!3d37.3623234!4d-6.0347906!16s%2Fg%2F1tddc2xc?entry=ttu"
                                class="nav-link" target="_blank">I.E.S. Sotero Hernandez</a>
                        </li>
                        <li class="nav-item">
