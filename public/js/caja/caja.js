...
document.addEventListener("DOMContentLoaded", () => {
    ...
    dia_anterior.addEventListener("click", (event) => {
        ...
        const url = `/cajaAdmin?fecha=${nuevaFecha}`;
...
function citasPeluquero(datos) {
    ...
    if (datos['data'].length === 0) {
        ...
        tablaHTML += '<li style="color: rgb(155, 39, 39)">SIN CITAS FINALIZADAS PARA EL DIA SELECCIONADO.</li>';
        tablaHTML += '</ul>';
        ...
        tablaHTML += '<th scope="col">Total Diario</th>';
        tablaHTML += '</tr>';
        tablaHTML += '</thead>';
